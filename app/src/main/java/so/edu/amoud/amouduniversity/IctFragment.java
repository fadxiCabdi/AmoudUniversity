...
public class IctFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup group, Bundle saved)
    {
        ...
        final ProgressDialog pd = ProgressDialog.show(getActivity(),  getResources().getString(R.string.faculty_of_computing_ict), "Please Wait", true);
        ...
        myWebView.loadUrl("https://results.amouduniversity.org/ict/exams/login.php");

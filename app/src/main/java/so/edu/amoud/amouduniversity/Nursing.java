...
public class Nursing extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup group, Bundle saved)
    {
        ...
        final ProgressDialog pd = ProgressDialog.show(getActivity(),  getResources().getString(R.string.school_of_nursing), "Please Wait", true);
        ...
        myWebView.loadUrl("https://results.amouduniversity.org/nursing/exams/login.php");

...
public class LaboratoryFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup group, Bundle saved)
    {
        ...
        final ProgressDialog pd = ProgressDialog.show(getActivity(),  getResources().getString(R.string.school_of_laboratory_technology), "Please Wait", true);
        ...
        myWebView.loadUrl("https://results.amouduniversity.org/laboratory/exams/login.php");

...
public class BusinessFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup group, Bundle saved)
    {
        ...
        final ProgressDialog pd = ProgressDialog.show(getActivity(),  getResources().getString(R.string.faculty_of_business_public_administration), "Please Wait", true);
        ...
        myWebView.loadUrl("https://results.amouduniversity.org/business/exams/login.php");

...
public class PublichealthFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup group, Bundle saved)
    {
        ...
        final ProgressDialog pd = ProgressDialog.show(getActivity(),  getResources().getString(R.string.school_of_public_health), "Please Wait", true);
        ...
        myWebView.loadUrl("https://results.amouduniversity.org/publichealth/exams/login.php");

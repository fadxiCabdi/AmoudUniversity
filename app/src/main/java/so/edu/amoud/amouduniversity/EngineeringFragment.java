...
public class EngineeringFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup group, Bundle saved)
    {
        ...
        final ProgressDialog pd = ProgressDialog.show(getActivity(),  getResources().getString(R.string.faculty_of_engineering), "Please Wait", true);
        ...
        myWebView.loadUrl("https://results.amouduniversity.org/engineering/exams/login.php");

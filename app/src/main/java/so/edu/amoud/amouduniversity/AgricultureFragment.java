...
public class AgricultureFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup group, Bundle saved)
    {
        ...
        final ProgressDialog pd = ProgressDialog.show(getActivity(),  getResources().getString(R.string.faculty_of_agriculture), "Please Wait", true);
        ...
        myWebView.loadUrl("https://results.amouduniversity.org/agriculture/exams/login.php");

...
public class EconomicsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup group, Bundle saved)
    {
        ...
        final ProgressDialog pd = ProgressDialog.show(getActivity(),  getResources().getString(R.string.faculty_of_economics_political_science), "Please Wait", true);
        ...
        myWebView.loadUrl("https://results.amouduniversity.org/economics/exams/login.php");

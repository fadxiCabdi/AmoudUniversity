...
public class LawFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup group, Bundle saved)
    {
        ...
        final ProgressDialog pd = ProgressDialog.show(getActivity(),  getResources().getString(R.string.faculty_of_sharia_law), "Please Wait", true);
        ...
        myWebView.loadUrl("https://results.amouduniversity.org/sharia_and_law/exams/login.php");
